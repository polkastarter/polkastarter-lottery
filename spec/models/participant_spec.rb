...
RSpec.describe Participant, type: :model do
  describe 'tickets' do
    ...
    context 'given balance is nil' do
      let(:participan) { Participant.new(identifier: 'AAAA', balance: nil) }
    ...
    context 'given balance is negative' do
      let(:participan) { Participant.new(identifier: 'AAAA', balance: -1) }
    ...
    context 'given balance is 0' do
      let(:participan) { Participant.new(identifier: 'AAAA', balance: 0) }
    ...
    context 'given balance is 250' do
      let(:participan) { Participant.new(identifier: 'AAAA', balance: 250) }
    ...
    context 'given balance is 30_000' do
      let(:participan) { Participant.new(identifier: 'AAAA', balance: 30_000) }
